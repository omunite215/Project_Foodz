    ...
    >
      ...
      <div className="flexStart flex-col gap-3 py-6 px-6">
        <div className="flexBetween w-full">
          ...
          >
           <Image src="/icons/fire.svg" width={28} height={28} alt="fire" className="object-contain" />
            <h3 className="special-offers-card-cooking-time">02:21:11</h3>
          </div>
        </div>
        <div className="flex justify-start items-center gap-3">
          <Image src="/icons/stars.svg" width={100} height={100} alt="stars" className=" object-contain" />
